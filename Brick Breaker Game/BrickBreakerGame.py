...
class Brick(GameObject):
    COLORS = {1: '#FF5733', 2: '#FFC300', 3: '#33FF57'}  # Custom brick colors
...
class Game(tk.Frame):
    def __init__(self, master):
        ...
        self.width = 610
        self.height = 400
        self.canvas = tk.Canvas(self, bg='#2c3e50',  # Dark background color
                                width=self.width,
                                height=self.height)
        self.canvas.pack()
        self.pack()
    ...
    def draw_text(self, x, y, text, size='40', color='#ecf0f1'):
        font = ('Forte', size)
